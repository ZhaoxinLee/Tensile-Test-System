...
# Project:  test\test.pro
# Template: app
# Command: C:\Qt\5.15.2\msvc2019_64\bin\qmake.exe -o Makefile test\test.pro -spec win32-msvc "CONFIG+=debug"
#############################################################################
...
Makefile: test\test.pro ..\..\..\..\Qt\5.15.2\msvc2019_64\mkspecs\features\spec_pre.prf \
	...
	$(QMAKE) -o Makefile test\test.pro -spec win32-msvc "CONFIG+=debug"
